...
/**
 * Defines the {@code Loginsubmitbutton} Sling Model used for the {@code reactcompass/components/loginsubmitbutton} component.
 * 
 */
@ConsumerType
public interface Loginsubmitbutton
