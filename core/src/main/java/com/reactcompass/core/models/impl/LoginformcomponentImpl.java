...
import com.reactcompass.core.models.Loginformcomponent;
...
@Model(adaptables = {
    ...
    Loginformcomponent.class,
    ComponentExporter.class
}, resourceType = "reactcompass/components/loginformcomponent")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class LoginformcomponentImpl
    implements Loginformcomponent
{
