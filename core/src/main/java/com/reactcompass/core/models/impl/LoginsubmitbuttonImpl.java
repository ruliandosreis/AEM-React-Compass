...
import com.reactcompass.core.models.Loginsubmitbutton;
...
@Model(adaptables = {
    ...
    Loginsubmitbutton.class,
    ComponentExporter.class
}, resourceType = "reactcompass/components/loginsubmitbutton")
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class LoginsubmitbuttonImpl
    implements Loginsubmitbutton
{
